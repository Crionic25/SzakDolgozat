...
public class kapcsTabla extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("AMNESIA nyilvántartó rendszer v1.5 Kapcsolatok");
    ...
    private void Update() throws SQLException {
        ...
        ResultSet rs = stat.executeQuery("Select * from dbo.anyagfajta2 ");
        ...
        try{
         Statement stat = con.createStatement();
        ResultSet rs = stat.executeQuery("Select * from dbo.varroda1 ");
        ...
        try{
         Statement stat = con.createStatement();
        ResultSet rs = stat.executeQuery("Select * from dbo.Beszállitó2 ");
        ...
        try{
         Statement stat = con.createStatement();
        ResultSet rs = stat.executeQuery("Select * from dbo.szab ");
